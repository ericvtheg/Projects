...
in class (ie, using the “ping-pong” strategy) to follow any of the rules described here:
https://softologyblog.wordpress.com/2013/08/29/cyclic-cellular-automata/
— Choose your own colors, number of states, etc.
— You can use these (non-GLSL) examples as inspiration, or come up with your own ideas:
http://jsfiddle.net/awilliams47/LJnue/, http://xpl.github.io/expression/.